<div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-12">
    ...
    <div class="bg-white rounded-4xl p-6 shadow-sm border border-slate-100 hover:shadow-md transition-shadow">
        ...
        <p class="text-slate-500 text-sm font-medium mb-1">Votre solde</p>
        <h3 class="text-2xl font-black text-red-500 tracking-tight">−320 <span class="text-sm font-bold text-red-300">DH</span></h3>
        
        <div class="mt-4">
            <span class="inline-flex items-center px-3 py-1 rounded-full bg-red-50 text-red-600 text-xs font-bold border border-red-100">
