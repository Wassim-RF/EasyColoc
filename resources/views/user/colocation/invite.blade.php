...
<body class="w-full bg-[#F8FAFC]">
    ...
    <div class="flex items-center gap-4 mb-10">
        <a href="{{ url()->previous() }}" class="w-10 h-10 bg-white border border-slate-200 rounded-xl flex items-center justify-center shadow-sm hover:bg-slate-50 transition-all">
    ...
    <div class="bg-white rounded-[2.5rem] p-8 md:p-12 shadow-sm border border-slate-100 relative overflow-hidden">
        ...
        <form action="{{ route('colocation.invite') }}" method="POST" class="relative space-y-8">
            ...
            <div class="pt-2">
                <button type="submit" class="w-full py-5 bg-orange-500 text-white rounded-[1.5rem] font-black text-lg tracking-tight hover:bg-orange-600 shadow-xl shadow-orange-200 transition-all transform hover:-translate-y-1 active:scale-95 flex items-center justify-center gap-3">
    ...
    <div class="mt-8 bg-blue-50/50 border border-blue-100 rounded-[1.5rem] p-6 flex gap-4">
