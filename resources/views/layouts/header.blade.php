<header class="bg-white border-b border-slate-100 sticky top-0 z-50">
    <div class="w-full mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="flex items-center gap-3">
            ...
            <!-- Logout direct f header -->
            <form action="{{ route('auth.logout') }}" method="POST" class="hidden sm:flex">
                @csrf
                <button type="submit" class="flex items-center gap-2 px-4 py-2 text-sm text-red-500 border border-red-100 rounded-2xl hover:bg-red-50 font-semibold transition-colors">
